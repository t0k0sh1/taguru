...
class AsyncContext:
    ...
    async def retract_source(self, source: str, *, dry_run: bool = False) -> RetractOutcome:
    ...
    async def audit_consolidation(
        ...
        *,
        ...
        result = await self._post("/consolidation/audit", body)
