...
__all__ = ["AsyncTaguru", "AsyncContexts", "AsyncContext"]
...
class AsyncContext:
    ...
    async def recall(self, cue: str, *, limit: int | None = None) -> MatchPage:
        """Associations whose subject/object entry-matches the cue."""
        result = await self._post("/recall", drop_none({"cue": cue, "limit": limit}))
